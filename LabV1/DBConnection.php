...
class DBConnection
{
    ...
    public function insertUser($email, $password, $name, $lastName, $sLastName, $username, $cellphone, $phone, $phoneCode)
    {
        ...
        $sql = "INSERT into users (email,password,name,lastName,sLastName,username,cellphone,phone,phoneCode) 
				values ('$email','$password','$name','$lastName','$sLastName','$username','$cellphone','$phone','$phoneCode')";
